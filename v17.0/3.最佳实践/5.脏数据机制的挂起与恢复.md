...
为了进行性能调整，建议使用 **<font color="#0066CC">suspendDirty</font>** 方法和 **<font color="#0066CC">resumeDirty</font>** 方法。

suspendDirty方法停止SpreadJS在单元格中标记脏状态，直到排序完成为止，resumeDirty方法允许您在需要时还原单元格的脏状态。 这两种方法都在很大程度上提高了性能。

请参考以下代码片段，以使用 **suspendDirty** 方法和 **resumeDirty** 方法，以便在使用SpreadJS时提高性能。
