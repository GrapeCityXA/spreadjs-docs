...
通过SpreadJS可以创建自定制的函数迷你图

![](/DOCUMENT_SITE_LINK_PREFIX_HERE/document-site-files/images/041236cd-4159-4f89-9e42-7be2bb789d22/images/sparkcustom.png)

使用以下步骤创建自定义迷你图。

- 使用 **SparklineEx** 类的 **createFunction** 方法。
- 通过 **addSparklineEx** 方法添加自定义迷你图。
- 使用公式显示迷你图。
