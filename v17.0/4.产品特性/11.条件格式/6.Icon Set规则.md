...
> **注意:** 在为图标标准设置自定义图标时，请务必确保 **IconSetType** 枚举在区域内选择。 另外，请确保为所选的IconSetType设置有效的iconIndex。<br /><br />例如：假设您选择“ threeTrafficLights”作为IconSetType。 由于threeTrafficLights将只有三个图标，因此您的iconIndex应该在0〜2之间。<br /><br />如果IconSetType或iconIndex不在范围内，则表单不会为用户设置的图标标准渲染任何图标，并且图标的空间将在单元格中显示为空白。<br /><br /> 
