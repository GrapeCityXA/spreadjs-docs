...
### 获取和设置单元格的默认值<span style="color: #a1b56c">（v16.2）</span>
...
* 使用 [GC.Spread.Sheets.CellRange](https://www.grapecity.com.cn/spreadjs/docs/v14/online/SpreadJS~GC.Spread.Sheets.CellRange.html) 类的`defaultValue`方法。
    ...
    ```
* 使用 [GC.Spread.Sheets.Worksheet](https://www.grapecity.com.cn/spreadjs/docs/v14/online/SpreadJS~GC.Spread.Sheets.Worksheet.html) 类的`getDefaultValue`和`setDefaultValue`方法。
...
此外，您还可以使用 [CopyToOptions](https://www.grapecity.com.cn/spreadjs/docs/v14/online/SpreadJS~GC.Spread.Sheets.CopyToOptions.html) 枚举的`defaultValue`选项复制单元格的默认值。
...
您可以使用 SpreadJS 设计器来设置默认单元格值，方法是在单元格的[上下文菜单](https://www.grapecity.com.cn/spreadjs/docs/v14/online/SpreadJS~GC.Spread.Sheets.ContextMenu.html)中选择“**Default Value...**”选项。这将打开“**Default Value Dialog**”，您可以在其中设置所选单元格的默认值。设置完默认值后，对话框会显示单元格的默认值。
