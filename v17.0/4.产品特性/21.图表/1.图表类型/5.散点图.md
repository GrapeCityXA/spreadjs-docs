...
散点图广泛用于说明各个项目或类别之间的关系。 该图表非常适合显示科学，统计和工程数据的比较。

可以在散点图中绘制表单的列或行中排列的数据。 与其他图表不同，散点图在绘图区域中分别在水平轴（也称为X轴）和垂直轴（也称为Y轴）中显示x和y变量的实际值。 通常，此图表将x和y值组合为单个数据点，并以不规则的间隔显示它们。 另外，该图表不使用类别轴，因为水平轴（主轴）和垂直轴（第二轴）都是值轴。

SpreadJS支持以下类型的散点图。 在下面显示的示例中，借助不同类型的散点图描绘了许多男性和女性的身高和体重分布。

-  **散点图** 
簇状散点图基于选定的数据范围显示数据点。 这可以帮助用户分析和确定x和y变量之间的关系。
An image of a scatter chart is shown below:![](/DOCUMENT_SITE_LINK_PREFIX_HERE/document-site-files/images/041236cd-4159-4f89-9e42-7be2bb789d22/images/xyscatter.png)
-  **带平滑线和数据标记的散点图:** 
带有平滑线和标记的散点图显示一条平滑曲线，该曲线连接特定系列中的所有数据点。
带有平滑线和标记的散点图的图像如下所示：![](/DOCUMENT_SITE_LINK_PREFIX_HERE/document-site-files/images/041236cd-4159-4f89-9e42-7be2bb789d22/images/xyscattersmooth.png)
-  **带平滑线的散点图:  ** 
带有平滑线的散点图显示一条平滑曲线，该曲线连接特定系列中的所有数据点，而不显示各个点。
带有平滑线的散点图的图像如下所示：![](/DOCUMENT_SITE_LINK_PREFIX_HERE/document-site-files/images/041236cd-4159-4f89-9e42-7be2bb789d22/images/xyscattersmoothnomarkers.png)
-  **带直线和数据标记的散点图** 
带有直线和标记的散点图显示一条直线，该直线连接特定系列中的所有数据点。
下图显示了具有直线和标记的散点图：![](/DOCUMENT_SITE_LINK_PREFIX_HERE/document-site-files/images/041236cd-4159-4f89-9e42-7be2bb789d22/images/xyscatterlines.png)
-  **带直线的散点图: ** 
带直线的散点图显示特定系列中数据点之间的直线连接线，而不显示各个点。
带有直线的散点图的图像如下所示：![](/DOCUMENT_SITE_LINK_PREFIX_HERE/document-site-files/images/041236cd-4159-4f89-9e42-7be2bb789d22/images/xyscatterlinesnomarkers.png)
-  **气泡图** 
气泡图非常适合财务数据分析。 它显示了散点图的变体，其中数据点被气泡替换，气泡尺寸代表三维（Z轴）。 该图表绘制了z（size）值以及x值和y值。 通常，当您要绘制三个数据系列时，可以使用此图表。 气泡的大小由第三数据序列中的值确定。
气泡图的图像如下所示：![](/DOCUMENT_SITE_LINK_PREFIX_HERE/document-site-files/images/041236cd-4159-4f89-9e42-7be2bb789d22/images/bubble_chart.png)



#### 示例代码

此代码显示了如何在表单中添加不同类型的散点图。
