...
|  *evaluateMode*  | The GC.Spread.CalcEngine.Functions. **AsyncFunctionEvaluateMode** type. 此参数是必要的。 |
|  *interval*  | 间隔以毫秒为单位。必须将evaluateMode设置为interval才能使用该选项。 |



#### 注释

如果想要控制公式如何重新计算时，请使用REFRESH函数。
