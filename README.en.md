...
| API reference (open source) | https://github.com/GrapeCityXA/SpreadJSApiDoc |
...
The complete API reference is here: **https://github.com/GrapeCityXA/SpreadJSApiDoc**
...
- The URL fragment (`#addSheet`) is the target API member name, which you can look up in [GrapeCityXA/spreadjs-api-reference](https://github.com/GrapeCityXA/SpreadJSApiDoc)
