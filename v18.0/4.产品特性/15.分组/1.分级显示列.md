...
你可以使用 [showRowOutline ](https://docs.grapecity.com.cn/spreadjs/help/api//classes/GC.Spread.Sheets.Worksheet#showrowoutline)方法在工作表中实现折叠和展开图标。树状结构中的层级对应缩进的次数。
