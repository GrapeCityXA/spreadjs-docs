...
`OpType` 的详细定义请参考文档：[操作类型枚举](gcdocsite__documentlink?toc-item-id=5ab30edb-2308-4b23-9e7f-9e738078e85b)。
...
更多详情请见：[扩展包安装与绑定](gcdocsite__documentlink?toc-item-id=2a6237c4-455d-4c03-ae02-257f0c5e84eb)。

#### 用户

新增用户概念及相关 API，支持用户绑定、权限设置和协同状态展示。详见：[用户与权限 API](gcdocsite__documentlink?toc-item-id=d56fb152-9b05-4331-a7b2-a9b38e1a0878)。
