...
工作簿目前提供了几个用于快照和变更集的 API，详情见 [协同插件-快照与变更集](gcdocsite__documentlink?toc-item-id=24d984bd-7688-4282-b8d3-e752a3aa5b58)。
...
操作介绍：[协同插件-快照与变更集 - 操作（Op）](gcdocsite__documentlink?toc-item-id=24d984bd-7688-4282-b8d3-e752a3aa5b58#%E6%93%8D%E4%BD%9Cop)
...
`spread-sheets-collaboration` 包提供了专为 SpreadJS 协同定制的 OT\_Type。用户可以通过引用直接使用它。
注册类型：
...
本章节包是对底层 [OT 类型](gcdocsite__documentlink?toc-item-id=89953b53-e259-4a92-a91d-aa7805748d7e) 接口的 SpreadJS 专属实现。如需了解 OT 类型的通用接口（`uri` / `create` / `transform` / `apply`）与自定义 OT 类型的方法，参见 [底层协同框架](gcdocsite__documentlink?toc-item-id=3e2d95c7-cc76-430c-a676-ad9aefea8594) 中的 [OT 类型](gcdocsite__documentlink?toc-item-id=89953b53-e259-4a92-a91d-aa7805748d7e)。