...
SpreadJS 提供了模式填充图表的支持。SpreadJS API 中的 [PatternType](gcdocsite__documentlink?toc-item-id=6223ba82-251e-433f-917e-a893642a62ea) 枚举允许用户在表单中的图表中应用不同的模式样式。您还可以为它指定前景色和背景色。
