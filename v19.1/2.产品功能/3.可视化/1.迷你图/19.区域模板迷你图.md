...
| **参数** | **描述** |
| --- | --- |
| *template\_range* | 指向区域模板的区域引用。 |
| *data\_expression* | 引用区域模板的对象数据。它接受单元格引用，其值为对象或对象函数的结果。您可以使用[OBJECT](gcdocsite__documentlink?toc-item-id=9ea36f28-42ac-4974-acc7-e7be2e547a5e)函数来定义对象。 |
