...
| **格式化类型** | **语法格式** | **示例** |
| ----- | ---- | --- |
| 常规单元格格式设置器 | 标准格式设置器 | "#,##0\_);(#,##0)"<br>"h:mm AM/PM" |
| 格式字符串 - 公式 | 标准公式 | "=SUM(@, C1)"<br>"=AVERAGE(C4:C7)" |
| 格式字符串 - 文本值模板 | 公式包含在 "{{" "}}" 中的文本字符串 | "After {{=@}} approval, Total Sales Were: {{=SUM(Sales4)}}"<br>“Hello, @” |
...
![FormatString1](/DOCUMENT_SITE_LINK_PREFIX_HERE/document-site-files/images/5fefd5d8-238b-4c13-893b-6f22fcc5b9dd/FormatString1.eff51c.gif)
