...
本教程基于《[SpreadJS 实时协同设计器](gcdocsite__documentlink?toc-item-id=52b398f1-8d89-43e2-a3a2-30a0f018b725)》教程，介绍如何配置权限（Permissions）功能。为便于理解核心逻辑，本教程在前端和后端使用相同的`mockUsers`模拟用户。在实际应用中，请根据具体业务需求进行修改。
