...
* [startBatchOp()](https://docs.grapecity.com.cn/spreadjs/help/api/enums/GC.Spread.Sheets.Collaboration.prototype#startbatchop)：启动批处理操作，允许将多个操作分组并合并为一个变更集（ChangeSet）。

```javascript
Workbook.collaboration.prototype.startBatchOp(): void
```

* [endBatchOp()](https://docs.grapecity.com.cn/spreadjs/help/api/enums/GC.Spread.Sheets.Collaboration.prototype#endbatchop)：结束当前批处理操作，将收集的所有操作最终合并为一个变更集（ChangeSet）。
