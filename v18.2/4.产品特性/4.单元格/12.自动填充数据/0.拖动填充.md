...
当涉及拖动填充的任何一种无效操作发生时，你可以通过 **invalidOperation** 事件接收诸如数据区域以及行/列数量等信息。
InvalidOperation 事件参数提供了一个名为 **fillRange** 的参数，当 invalidType 为 **dragFill** 时，该参数会返回用于填充操作的区域。
![dragfill-invalid.c955b4](/DOCUMENT_SITE_LINK_PREFIX_HERE/document-site-files/images/5fefd5d8-238b-4c13-893b-6f22fcc5b9dd/dragfill-invalid.c955b4.985d3b.gif)
以下代码示例展示了在使用拖动填充操作时，如何检索有关无效区域的信息。
