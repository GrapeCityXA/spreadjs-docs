...
SpreadJS 表格协同提供两种文档模式：**查看模式（View Mode）** 和 **编辑模式（Edit Mode）**。通过权限功能，用户可在**查看模式**中配置特定操作权限，从而在协同环境中实现灵活性与安全性的平衡。

## 功能说明

以下是两种文档模式的详细介绍（参考 [用户 - BrowsingMode](gcdocsite__documentlink?toc-item-id=d56fb152-9b05-4331-a7b2-a9b38e1a0878#a-hrefgcdocsite__documentlinktoc-item-id35310e62-ca76-4d06-87ae-7890ab0f7bce-titlebrowsingmodea)）：
