...
* **Auto Fill Number** -如果startRange包含数字值，则填充句柄将自动完成整列中的数字列表，如下所示。 数字序列将根据相应的模式和填充手柄的选定选项进行填充。
    ![number-gif](/DOCUMENT_SITE_LINK_PREFIX_HERE/document-site-files/images/5fefd5d8-238b-4c13-893b-6f22fcc5b9dd/number-gif.4a09c0.gif)
* **Auto Fill Dates -** 如果startRange包含日期值，则填充句柄将自动完成整列中的日期列表，如下所示。 默认情况下，当您双击自动填充日期时，填充手柄将执行“复制单元格”操作。 要填充连续的日期，您可以打开拖动填充智能标记，然后选择“填充系列”选项。
    ![date-gif](/DOCUMENT_SITE_LINK_PREFIX_HERE/document-site-files/images/5fefd5d8-238b-4c13-893b-6f22fcc5b9dd/date-gif.ff8be3.gif)
* **Auto Fill Formulas** \- 如果startRange包含公式，则填充句柄将公式向下复制到整个列中，如下所示。
    ![formula-gif](/DOCUMENT_SITE_LINK_PREFIX_HERE/document-site-files/images/5fefd5d8-238b-4c13-893b-6f22fcc5b9dd/formula-gif.227330.gif)

> **注意:** 双击进行自动填充操作时应牢记以下几点。
>
> * 仅当填充手柄附近的列中有非空单元格时，这种类型的自动填充才有效。
> * 当您双击填充手柄以填充列中的数据时，它将仅向下延伸到当前区域中的最后一个非空单元格。
> * 另外，如果相邻列包含一些空单元格，则双击填充手柄将填充该列，直到相邻列中的最后一个非空单元格。
