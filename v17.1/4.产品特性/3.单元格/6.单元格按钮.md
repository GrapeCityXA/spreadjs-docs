...
| ButtonImageType | 该属性是ButtonImageType枚举类型，指定单元格按钮的图像类型。您可以根据特定偏好配置按钮图像类型，例如下拉、搜索、撤消、重做。完整列表请参考[ButtonImageType Enumeration](gcdocsite__documentlink?toc-item-id=07b2a68f-cac4-4ad2-8b17-a9af69ac270d)。 |
