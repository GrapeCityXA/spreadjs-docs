...
| 特性 | 描述 |
|--- |--- |
| name<br /><br /> *string* <br /><br /> | 项名称 |
| icons<br /><br /> *(string | GC.Spread.Sheets.ButtonImageType)* <br /><br /> | 表示不同状态的一系列图标 |
| iconSelector<br /><br /> *(item: any, index: number) => number | boolean* <br /><br /> | 根据不同的状态选择一个图标。 |
| tooltip<br /><br /> *String* <br /><br /> | 行操作提示。 |
| command<br /><br /> *string* <br /><br /> | 单击行操作时命令的名称。 |
| shortcutKey<br /><br /> *GC.Spread.Sheets.TableSheet.IShortcutKey* <br /><br /> | 行操作命令的快捷键。 |
