...
| Setting | （可选参数）JSON格式的字符串。 例如："{{axisColor：rgb(255,255,0),firstMarkerColor：brown，highMarkerColor：red，lastMarkerColor：blue，lowMarkerColor：green，markersColor：purple，negativeColor：yellowgreen，seriesColor:pink,displayXAxis:true,showFirst:true,<br />showHigh:true,showLast:true,showLow:true,showNegative:true,showMarkers:true,lineWeight:3,displayHidden:false, displayEmptyCellsAs:1,rightToLeft:false,minAxisType:1,maxAxisType:1,<br />manualMax:5,manualMin:-3}"。 |
