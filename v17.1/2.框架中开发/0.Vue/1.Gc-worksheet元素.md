# UsingtheGC-worksheetElement

下表列出了gc-worksheet元素的属性。
...
| rowHeaderVisible | Worksheet.options.rowHeaderVisible = value | boolean |  |
...
| columnOutlineInfo |  | any[] | 一个包含列大纲信息的数组，例如[{index：1，count：10}） |
