# UsingtheSpreadSheetsElement

下表列出了SpreadSheets元素的属性。
...
| hostStyle |  | any (host元素的样式与AngularJS中的样式绑定相同。 例如; {width：400px，height：600px} ) |
| hostClass |  | string (宿主元素的类名称) |

下表列出了输出事件。

|  **属性**  |  **API 参考**  |  **备注**  |
|--- |--- |--- |
| workbookInitialized |  | 返回工作簿实例，args (spread: workbook) |
...
|  **子元素**  |  **API 参考**  |  **计数**  |
|--- |--- |--- |
| Worksheet | GC.Spread.Sheets.Worksheet | any |
